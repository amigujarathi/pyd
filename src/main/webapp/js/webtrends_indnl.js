...
function dcsTag(){var P="http"+(window.location.protocol.indexOf('http://www.icicibank.com/sitemap.page')==0?'s':'')+"://"+gDomain+(gDcsId==""?'':'/'+gDcsId)+"/dcs.gif?";for(N in DCS){if(DCS[N]){P+=A(N,DCS[N]);}}
