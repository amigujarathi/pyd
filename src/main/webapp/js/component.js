...
var resizeableImage = function(image_target) {
  ...
  init = function(){
    ...
    //orig_src.style.backgroundImage = "url('../img/cred.png')";
...
//   context.stroke();
   ...
   //crop_canvas.appendChild("<img src='"+imageObj.src+"' />");

   
   
   var link=crop_canvas.toDataURL("image/png");
    window.open(link);
  }
